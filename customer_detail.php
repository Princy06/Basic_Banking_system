 ...
 <a href="index.php"> <i class="fa fa-home"></i>HOME</a>
    ...
    <table >
		...
		<tr>
			...
			<td>
				<form action="customer.php" method="post"  class="view">
					<button class="button1" type="submit" name="name" value="princy">View</button>
		...
		<tr>
			...
			<td>
				<form action="customer.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Niharika">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="customer.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Supriya">View</button>
				</form>
			</td>
		</tr>
     <tr>
        ...
        <tr>
			...
			<td>
				<form action="customer.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Swara">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="customer.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Asit">View</button>
				</form>
			</td>
		</tr> 
		</tbody>
